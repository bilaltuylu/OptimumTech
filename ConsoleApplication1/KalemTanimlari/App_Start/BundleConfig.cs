...
namespace KalemTanimlari
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // jQuery Form
            bundles.Add(new ScriptBundle("~/plugins/jqueryForm").Include("~/Scripts/jquery.form.min"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/validate").Include(
                "~/Scripts/jquery.validate.min.js",
                 "~/Scripts/localization/messages_tr.js"));
            ...
            // Password meter 
            bundles.Add(new ScriptBundle("~/plugins/passwordMeter").Include(
            ...
            // geocomplete
            bundles.Add(new ScriptBundle("~/geocomplete").Include(
            ...
            // toggle styles
            bundles.Add(new StyleBundle("~/bootstrap-toggleStyles").Include(
            ...
            // Select2 Styless
            bundles.Add(new StyleBundle("~/select2Styles").Include(
            ...
            // Data TableOptimum InLine Edit
            bundles.Add(new ScriptBundle("~/app/dtOptimumEdit").Include(
                     "~/Scripts/app/dtOptimumEdit.min.js"));


            // moment.js
            bundles.Add(new ScriptBundle("~/Scripts/moment.min.js").Include(
